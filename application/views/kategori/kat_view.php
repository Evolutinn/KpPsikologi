					...
					<div class="kt-portlet__head-wrapper">
						...
						<?php if(!empty($this->input->get('id'))){?>
							<a href="" class="btn btn-primary kt-btn kt-btn--pill" data-toggle="modal"
								data-target="#kt_select_modal">Edit Kategori</a>
								<?php }else{?>
									<a href = "" class="btn btn-success kt-btn kt-btn--pill" data-toggle="modal"
								data-target="#kt_select_modal">Tambah Kategori</a>		
								<?php }?>		
		...
		<div class="modal fade" id="kt_select_modal" role="dialog" aria-labelledby="" aria-hidden="true">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<?php if(!empty($this->input->get('id'))){?>
					<form class="kt-form kt-form--label-right" method="post" action="<?= base_url('data/katproses');?>">
						<div class="modal-body">
							<div class="form-group row kt-margin-t-20">
								<label class="col-form-label col-lg-3 col-sm-12">Standard Input</label>
								<div class="col-lg-9 col-md-9 col-sm-12">
									<input type="text" class="form-control" type="text" name="kategori" value="<?=$kat->nama_kategori;?>" id="kategori" class="form-control"  placeholder="Contoh : Pemrograman Web" />
								</div>
							</div>
					...
					<form class="kt-form kt-form--label-right" method="post" action="<?= base_url('data/katproses');?>">
						...
						<div class="form-group row kt-margin-t-20">
								...
								<div class="col-lg-9 col-md-9 col-sm-12">
									<input type="text" class="form-control" name="kategori" id="kategori" class="form-control"  placeholder="Contoh : Pemrograman Web" />
								</div>
							</div>
						</div>
						<div class="modal-footer">
